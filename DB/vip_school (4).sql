...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 19 juin 2026 à 11:17
...
(3, '795422d3-6369-11f1-9d55-9c7bef735b1f', 'MATERIEL', 'Mat??riels scolaires', '2026-06-08 20:40:08', NULL);
...
INSERT INTO `etudiants` (`id_etudiant`, `uuid`, `matricule`, `numero_ordre`, `nom`, `postnom`, `prenom`, `date_naissance`, `lieu_naissance`, `sexe`, `categorie`, `adresse`, `adresse_permanente`, `telephone`, `email`, `tuteur_nom`, `tuteur_telephone`, `photo`, `id_utilisateur`, `actif`, `cree_le`, `modifie_le`, `deleted_at`) VALUES
(1, 'ETU-fbf5c8199f0399b95f70fc3f1dc6', 'MAT-0001', '1', 'Dupont', 'Dupont', 'Jean', '2005-01-15', NULL, 'M', NULL, 'Kinshasa, Commune de la Gombe', NULL, '+243811000001', 'jean.dupont@email.com', NULL, NULL, '', NULL, 1, '2026-06-09 22:34:08', '2026-06-09 22:51:12', NULL),
(2, 'ETU-507ae6d117cf82f9949f527d98ce', 'MAT-0002', '2', 'Mukendi', 'Mukendi', 'Marie', '2006-02-15', NULL, 'F', NULL, 'Kinshasa, Commune de la Gombe', NULL, '+243811000002', 'marie.mukendi@email.com', NULL, NULL, '', NULL, 1, '2026-06-09 22:34:08', '2026-06-09 22:57:21', NULL),
(3, 'ETU-58cfcd3f88c68f0b7ace58662ac6', 'MAT-0003', '2', 'Kabongo', 'Kabongo', 'Pierre', '2007-03-15', NULL, 'M', NULL, 'Kinshasa, Commune de la Gombe', NULL, '+243811000003', 'pierre.kabongo@email.com', NULL, NULL, '', NULL, 1, '2026-06-09 22:34:08', '2026-06-18 17:12:14', NULL),
(4, 'ETU-80c808283af8dcb819ea0c92849c1e8e', 'MAT-0004', '1', 'Ilunga', 'Ilunga', 'Esther', '2008-04-15', NULL, 'F', NULL, 'Kinshasa, Ngaliema', '', '+243811000004', 'esther.ilunga@email.com', NULL, NULL, '', NULL, 1, '2026-06-09 22:37:07', '2026-06-18 17:12:14', NULL),
(5, 'ETU-6e995fb45570811845ae886a608c975f', 'MAT-0005', '5', 'Tshimanga', 'Tshimanga', 'David', '2009-05-15', NULL, 'M', NULL, 'Kinshasa, Lemba', NULL, '+243811000005', 'david.tshimanga@email.com', NULL, NULL, '', NULL, 1, '2026-06-09 22:37:08', '2026-06-09 22:50:57', '2026-06-09 20:50:57');
...
CREATE TABLE IF NOT EXISTS `parents` (
  ...
  `uuid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_etudiant` int NOT NULL,
  `type` enum('pere','mere','tuteur') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  UNIQUE KEY `uuid` (`uuid`),
  UNIQUE KEY `uniq_parent` (`id_etudiant`,`type`),
  KEY `idx_parents_etudiant` (`id_etudiant`),
  KEY `id_utilisateur` (`id_utilisateur`)
...
INSERT INTO `parents` (`id_parent`, `uuid`, `id_etudiant`, `type`, `nom`, `profession`, `telephone`, `email`, `id_utilisateur`, `adresse`, `relation`, `cree_le`, `modifie_le`, `deleted_at`) VALUES
(1, 'PAR-08b9835f78c08f492336104604b8', 1, 'pere', 'Dupont Alphonse', 'Ingenieur', '+243811000011', NULL, NULL, NULL, NULL, '2026-06-09 22:34:08', '2026-06-09 22:51:13', NULL),
(2, 'PAR-4144a1f26d2cac972ce0666c1cfc', 1, 'mere', 'Dupont Claire', 'Enseignante', '+243811000012', NULL, NULL, NULL, NULL, '2026-06-09 22:34:08', '2026-06-09 22:51:13', NULL),
(3, 'PAR-c7a25718c4e1ad95dfc24305771b', 2, 'pere', 'Mukendi Joseph', 'Commercant', '+243811000021', NULL, NULL, NULL, NULL, '2026-06-09 22:34:08', '2026-06-09 22:57:21', NULL),
(4, 'PAR-e4aaea41165494c408c20483604f', 2, 'mere', 'Mukendi Beatrice', 'Menagere', '+243811000022', NULL, NULL, NULL, NULL, '2026-06-09 22:34:08', '2026-06-09 22:57:21', NULL),
(5, 'PAR-c120a5580a0b50a0d4a7d76423eea6c1', 3, 'pere', 'Kabongo Robert', 'Medecin', '+243811000031', NULL, NULL, NULL, NULL, '2026-06-09 22:37:07', '2026-06-09 22:57:41', NULL),
(6, 'PAR-2e7aa6675d974cda1d0fe9e6113bb31b', 3, 'mere', 'Kabongo Louise', 'Infirmiere', '+243811000032', NULL, NULL, NULL, NULL, '2026-06-09 22:37:07', '2026-06-09 22:57:41', NULL),
(7, 'PAR-efecf3e8b5d871868edaee6d2571854e', 3, 'tuteur', 'Kabongo Michel', 'Avocat', '+243811000033', '', NULL, '', '', '2026-06-09 22:37:07', '2026-06-09 22:57:41', NULL),
(8, 'PAR-422ae463e0bb2775125eead9b81a5be0', 4, 'mere', 'Ilunga Noelie', 'Fonctionnaire', '+243811000042', NULL, NULL, NULL, NULL, '2026-06-09 22:37:07', '2026-06-09 22:55:13', NULL),
(9, 'PAR-cd8de0faa0534dcd9ef6c3b176333ec5', 4, 'tuteur', 'Ilunga Paul', 'Banquier', '+243811000043', '', NULL, '', '', '2026-06-09 22:37:07', '2026-06-09 22:55:13', NULL),
(10, 'PAR-3143cadd3998dbc03a0f9b9e9429df55', 5, 'pere', 'Tshimanga Felix', 'Agriculteur', '+243811000051', NULL, NULL, NULL, NULL, '2026-06-09 22:37:08', '2026-06-09 22:50:57', '2026-06-09 20:50:57'),
(11, 'PAR-945a624aa36edad1987900da981813b7', 5, 'mere', 'Tshimanga Rose', 'Menagere', '+243811000052', NULL, NULL, NULL, NULL, '2026-06-09 22:37:08', '2026-06-09 22:50:57', '2026-06-09 20:50:57');
...
INSERT INTO `produits` (`id_produit`, `uuid`, `id_categorie`, `code`, `libelle`, `description`, `prix_unitaire`, `stock_mini`, `stock_actuel`, `unite`, `cree_le`, `modifie_le`, `deleted_at`) VALUES
(1, '59625ff8-a2f2-4874-9769-e5c407b73b9f', 3, 'siue', 'ddsilfjiow', NULL, 23.00, 5, 23, 'pi??ce', '2026-06-18 15:18:19', '2026-06-18 15:18:32', NULL);
