...
class Programmes extends MY_Controller {
    ...
    public function api_create() {
        ...
        if ($softDeleted) {
            $updateData = [
                ...
                'nb_heures_par_jour' => $data['nb_heures_par_jour'] ?? 0.0,
                'nb_heures_par_semaine' => $data['nb_heures_par_semaine'] ?? 0.0
            ];
    ...
    public function api_update($id) {
        ...
        $allowed = ['id_matiere', 'id_classe', 'coefficient', 'nb_heures_par_jour', 'nb_heures_par_semaine'];
    ...
    public function api_delete($id) {
        ...
        if ($this->Model->update('matieres_classes', ['uuid' => $id], ['deleted_at' => $now])) {
            // Propager aux enseignements liés
