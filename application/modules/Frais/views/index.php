...
(function() {
  var _f = function() {
    ...
    loadTypes();
    loadPaiements();
    autoSetup('payEtudiant_search', 'payEtudiant', 'payEtudiant_results', etudiantsData.map(function(e) { return { id: e.id_etudiant, nom: e.fullname || e.nom, prenom: e.prenom || '', matricule: e.matricule }; }), function(e) { return e.nom + ' (' + (e.matricule || '') + ')'; });
