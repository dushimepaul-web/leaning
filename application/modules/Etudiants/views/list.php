    ...
    rows += `<tr>
      ...
      <td>
        <div class="d-flex align-items-center gap-8">
          <a href="${BASE_URL}Etudiants/details/${e.uuid}" class="text-primary-light text-xl"><i class="ri-user-3-line"></i></a>
          <a href="${BASE_URL}Etudiants/edit/${e.uuid}" class="text-warning text-xl"><i class="ri-edit-2-line"></i></a>
