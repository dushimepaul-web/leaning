      ...
      <div class="card shadow-1 radius-8 gradient-bg-end-4 h-100">
        <div class="card-body p-24">
          <div class="d-flex align-items-center gap-3 mb-16">
            ...
            <p class="fw-medium text-primary-light mb-1">Recettes Totales</p>
          </div>
          <h4 class="mb-0"><?= number_format($total_recettes ?? 0, 0, ',', ' ') ?> FBU</h4>
        </div>
      </div>
    </div>
    <div class="col-xl-4 col-sm-6">
        ...
        <div class="card-body p-24">
          <div class="d-flex align-items-center gap-3 mb-16">
            <div class="w-48-px h-48-px bg-success-600 rounded-circle d-flex justify-content-center align-items-center">
              <i class="ri-user-shared-line text-white text-xl"></i>
            </div>
            <p class="fw-medium text-primary-light mb-1">Inscriptions</p>
          </div>
          <h4 class="mb-0"><?= $total_inscriptions ?? 0 ?></h4>
        </div>
      </div>
    </div>
    <div class="col-xl-4 col-sm-6">
      <div class="card shadow-1 radius-8 gradient-bg-end-6 h-100">
        <div class="card-body p-24">
          ...
          <h4 class="mb-0"><?= $total_utilisateurs ?? 0 ?></h4>
        </div>
      </div>
    </div>
  </div>
